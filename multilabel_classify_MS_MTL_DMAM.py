...
parser.add_argument('--schedule', type=int, nargs='+', default=[10, 30],  # 在线降低 学习率  --已无用
...
#    from resnext_MulTask_11 import resnext50_elastic
    from resnext_MulTask_MS import resnext50_elastic
...
#        train_multi(train_loader, model, criterion, optimizer, epoch, iteration_size)
        ...
        print("***********************************************")
        test_CF, test_OF = validate_multi(val_loader, model, criterion) # 模型验证
...
#        }, False, filename='3-MSCOCO--model-train-demo/'+ 'coco_' + args.arch + '_checkpoint.pth.tar') 
